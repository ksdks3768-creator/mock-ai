...
export const LogoIcon = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M7.16239 2.3248C7.5458 1.94139 8.16912 1.94139 8.55253 2.3248L12.0833 5.85557C12.4667 6.23898 12.4667 6.8623 12.0833 7.24571L8.55253 10.7765C8.16912 11.1599 7.5458 11.1599 7.16239 10.7765L3.63162 7.24571C3.24821 6.8623 3.24821 6.23898 3.63162 5.85557L7.16239 2.3248Z" />
    <path d="M18.8376 2.3248C19.221 1.94139 19.8443 1.94139 20.2277 2.3248L23.7585 5.85557C24.1419 6.23898 24.1419 6.8623 23.7585 7.24571L20.2277 10.7765C19.8443 11.1599 19.221 11.1599 18.8376 10.7765L15.3068 7.24571C14.9234 6.8623 14.9234 6.23898 15.3068 5.85557L18.8376 2.3248Z" opacity="0.5" />
    <path d="M7.16239 13.2235C7.5458 12.8401 8.16912 12.8401 8.55253 13.2235L12.0833 16.7543C12.4667 17.1377 12.4667 17.761 12.0833 18.1444L8.55253 21.6752C8.16912 22.0586 7.5458 22.0586 7.16239 21.6752L3.63162 18.1444C3.24821 17.761 3.24821 17.1377 3.63162 16.7543L7.16239 13.2235Z" opacity="0.5" />
    <path d="M18.8376 13.2235C19.221 12.8401 19.8443 12.8401 20.2277 13.2235L23.7585 16.7543C24.1419 17.1377 24.1419 17.761 23.7585 18.1444L20.2277 21.6752C19.8443 22.0586 19.221 22.0586 18.8376 21.6752L15.3068 18.1444C14.9234 17.761 14.9234 17.1377 15.3068 16.7543L18.8376 13.2235Z" />
  </svg>
);
...
export const SendIcon = ({ className }: { className?: string }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 10.5L21 3M21 3L13.5 21L10.5 13.5M21 3L10.5 13.5" />
  </svg>
);
...
export const CodeBracketIcon = ({ className }: { className?: string }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 7.5l3 2.25-3 2.25m9-4.5l-3 2.25 3 2.25M6 20.25h12A2.25 2.25 0 0020.25 18V6A2.25 2.25 0 0018 3.75H6A2.25 2.25 0 003.75 6v12A2.25 2.25 0 006 20.25z" />
  </svg>
);

export const UsersIcon = ({ className }: { className?: string }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962a3.75 3.75 0 100-7.5 3.75 3.75 0 000 7.5zM3.75 18.72v-3.75A3.375 3.375 0 017.125 11.625h6.75a3.375 3.375 0 013.375 3.375v3.75m-16.5 0a3.004 3.004 0 003.75 2.25h9.75a3.004 3.004 0 003.75-2.25m-16.5 0c0 2.22.95 4.21 2.5 5.625" />
  </svg>
);
